...
The app is in active development but showcases a few modern tech features around the React ecosystem.
...
- [NextJS (Server-Side Rendering)](https://nextjs.org)
  - Somewhat magical platform - I had writted this in create-react-app starting out, then used to implement SSR with great success
